package employee_managent_system;
...
public class Employee implements Serializable {
	...
	{	
		static void display(ArrayList<Employee> al)
		{
			...
			for(Employee e : al)
			{
				System.out.println(String.format("%-10s%-15s%-10s%-20s%-10s",e.id,e.name,e.salary,e.contact_no,e.email_id));
			}
		}
		...
		public static void main(String[] args)
		{
			...
			try{
				...
				f = new File("C:\\management\\EmployeeDataList1.txt");
				if(f.exists())
				{
			...
			do
			{
				...
				case 6: try {
						...
						System.out.println("\nYou have chosen EXIT !! Saving changes and closing application!. \n \t \t Bye!!!");
						sc.close();
						System.exit(0);
						break;
